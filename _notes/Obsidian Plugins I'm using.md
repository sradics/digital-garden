...
| ------ | ----------- | ---------- | ------- |
|Auto Note Mover|Auto Note Mover will automatically move the active notes to their respective folders according to the rules.|[https://github.com/farux/](https://github.com/farux/)| rarely used|
